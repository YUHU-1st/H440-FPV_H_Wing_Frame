"""Create deterministic current-file manufacturing archives for H440 B1."""
...
if len(print_files) != 19:
    raise RuntimeError(f"expected 19 printed-part STEP files, found {len(print_files)}")
