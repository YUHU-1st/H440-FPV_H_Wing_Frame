...
import ezdxf
import vtk
O=R/'H440_B1';report=json.loads((O/'geometry_report.json').read_text(encoding='utf-8'))
hardware=[
...
frame=cq.importers.importStep(str(O/'H440_B1_FRAME_multibody.step'))
travel=[]
for z in [-105,-75,-45]:
...
tx=vtk.vtkTextActor();tx.SetInput(f'H440 B1 / HYBRID\nPLA wings + CFRP plates + continuous tube spars\nCAD structure {report["CAD_frame_mass_g"]:.0f} g; assembled frame budget 550 g')
...
for name,pos,scale in [('H440_B1_isometric.png',(480,340,550),265),('H440_B1_front.png',(0,0,800),240)]:
