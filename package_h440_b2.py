"""Create deterministic current-file manufacturing archives for H440 B2."""
...
OUT = ROOT / "H440_B2"
PRINT_ARCHIVE = OUT / "H440_B2_printed_parts_STEP.zip"
PRINT_README = OUT / "打印件STEP交付说明.md"
PRINT_README_EN = OUT / "PRINTED_STEP_NOTES_EN.md"
SUPPLIER_ARCHIVE = OUT / "H440_B2_supplier_DXF_STEP.zip"
