"""Verify CRC, SHA-256 manifests and disk/ZIP identity for H440 B3 deliverables."""
...
verify(OUT / "H440_B3_supplier_DXF_STEP.zip", expected_steps=7, expected_dxfs=7)
verify(OUT / "H440_B3_printed_parts_STEP.zip", expected_steps=18, expected_dxfs=0)
