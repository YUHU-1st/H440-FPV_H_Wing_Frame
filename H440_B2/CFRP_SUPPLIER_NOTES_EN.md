# H440 B2 CFRP Supplier Notes

`H440_B2_supplier_DXF_STEP.zip` contains the cutting definition for the H440 B2 flat CFRP parts. Use the seven files in `DXF/` for 2D machining. Same-name solids in `STEP/` are supplied for contour, hole-location and nominal-thickness reference.
...
| C05_pylon_R_4mm | Solid CFRP sheet | 4 mm | 1 |
| C06_pylon_L_4mm | Solid CFRP sheet | 4 mm | 1 |
...
B2 uses bonded mortises for the center trays: nominal slots 2.2 x 12.2 mm with R0.6 corner relief. Dry-fit actual laminate before full production. Both pylons are 4 mm and must not be mixed with B1 parts.
